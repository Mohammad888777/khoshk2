# Generated by Django 5.0 on 2024-11-19 13:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, db_column='username', db_index=True, help_text='username', max_length=150, null=True, verbose_name='username')),
                ('phone', models.CharField(db_column='phone', db_comment='phone unique', db_index=True, help_text='phone', max_length=11, unique=True, validators=[account.models.validate_phone], verbose_name='phone')),
                ('first_name', models.CharField(blank=True, db_column='first_name', db_comment='first name', db_index=True, help_text='first name', max_length=100, null=True, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, db_column='last_name', db_comment='last name', db_index=True, help_text='last name', max_length=100, null=True, verbose_name='last name')),
                ('email', models.EmailField(blank=True, db_column='email', db_comment='email address', db_index=True, help_text='email', max_length=250, null=True, unique=True, verbose_name='email')),
